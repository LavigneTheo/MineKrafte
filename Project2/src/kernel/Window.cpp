...
void Window::build(const int& width, const int& height, const bool& fullScreen) {
...
void Window::key_callback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
	...
	if (action == GLFW_PRESS && key == GLFW_KEY_LEFT_SHIFT)
		m_key_pressed[GLFW_KEY_LEFT_SHIFT] = true;
	if (action == GLFW_PRESS && key == GLFW_KEY_SPACE)
		m_key_pressed[GLFW_KEY_SPACE] = true;
	...
	if (action == GLFW_RELEASE && key == GLFW_KEY_LEFT_SHIFT)
		m_key_pressed[GLFW_KEY_LEFT_SHIFT] = false; 
	if (action == GLFW_RELEASE && key == GLFW_KEY_SPACE)
		m_key_pressed[GLFW_KEY_SPACE] = false;


	if (action == GLFW_PRESS && key == GLFW_KEY_ESCAPE)
		m_key_pressed[GLFW_KEY_ESCAPE] = true;
}
